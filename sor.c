...
int main()
{
    ...
    [SCENE_OUTSIDE_NERBY_HOME] = {
        ...
        .line ={
            ...
            .next_line = 33},
            {.persona_name = " ",
            .text = "Медленно, но, солнце начало пробиватся из-за облаков. На коже и темной форме начало чувтсвувотся тепло.",
            .next_line = 34},
            {.persona_name = " ",
            ...
            .next_line = 38},
            {.persona_name = "Виктор",
            .text = "Буду тебе оченеь признателен.",
            .next_line = 39},
            {.persona_name = "Ганс",
            .text = "Да, конечно...",
            .next_line = 40},
            {.persona_name = " ",
            .text = "Я оборвано ответил ему.",
            .next_line = 41},
            {.persona_name = " ",
            .text = "Повторно посмотрев на руку, часы показывали уже пятьдесят четыре минуты.",
            .next_line = 42},
            {.persona_name = " ",
            .text = "~Порабы уже иди к аудитории~",
            .next_line = 43},
            {.persona_name = " ",
            .text = "Я начал направлятся к дверям университета, Виктор молча пошел за мной, как бы говоря \"я тебя понял\".",
    ...
    [SCENE_UNIVERSITY_ENTRANCE_HALL] = {
        ...
        .line = {
            {.persona_name = " ",
            .text = "Корридор был забит народом. Сладовалось ощущение будто бы даже яблоко не сможет упасть там.",
            .next_line = 1},
            {.persona_name = " ",
            .text = "Вик, что-то рассказывал по пути как мы вошли в здание. Но мыслями я был совсем не в школе.",
            .next_line = 2},
            {.persona_name = " ",
            .text = "А ведь и в правду, почему нет ни одного следа проникнавения в систему, должны же быть логи какие-то.",
            .next_line = 3},
            {.persona_name = " ",
            .text = "~Ленокс...~",
            .next_line = 4},
            ...
            .next_line = 5},
            {.persona_name = " ",
            .text = "~В любом случае... Произошедшее вообще не сладывается воедино.~",
            .next_line = 6},
            {.persona_name = " ",
            .text = "Подойдя к аудитории я снял сумку с плеча и положил на лавочку рядом со своей аудиторией.",
            .next_line = 7},
            {.persona_name = " ",
            .text = "Виктор поступил точно также, предварительно достав тетрадку по алгоритмам.",
            .next_line = 8},
            {.persona_name = "Ганс",
            .text = "Стоит отметить то, что я удивлен тому, что кто-то еще делает записи от руки в этой странне.",
            .next_line = 9},
            {.persona_name = " ",
            ...
            .next_line = 12},
            {.persona_name = " ",
            .text = "Я собрал вечь и кивком головы указал Вику, что собираюсь во внутрь аудитории. Вик не медля пошел за мной.",
