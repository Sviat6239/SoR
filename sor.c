...
int main()
{
    ...
    [SCENE_UNIVERSITY_ENTRANCE_HALL] = {
        ...
        .line = {
            {.persona_name = " ",
            .text = "Коридор был забит народом. Складовалось ощущение будто бы даже яблоко не сможет упасть там.",
            .next_line = 1},
            {.persona_name = " ",
            ...
            .next_line = 12},
            {.persona_name = " ",
            .text = "Я собрал вещи и кивком головы указал Вику, что собираюсь во внутрь аудитории. Вик не медля пошел за мной.",
